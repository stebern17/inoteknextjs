  ...
  return (
    <section className="content flex flex-col font-display justify-center lg:py-24 gap-3">
      ...
      <p className="text-justify text-base md:text-lg">
        ...
        produk <span className="font-bold">wall panel modern asal Jepang </span>
        ...
        bersama Nichiha menyediakan solusi fasad yang praktis, kuat, dan indah,
        sehingga memudahkan arsitek, kontraktor, hingga pemilik rumah dalam
        mewujudkan fasad terbaik. Dedikasi kami sebagai distributor mendukung
        terwujudnya proyek-proyek unggulan di seluruh Indonesia, mulai dari
        hunian premium hingga gedung komersial berkelas.
      </p>
    </section>
  );
}
